###NPCoronaPredict-GUI README file, last updated 19/10/2023 by Ian Rouse, ian.rouse@ucd.ie
...
Introduction
----------------------
NPCoronaPredict-GUI is a simple graphical interface for running UnitedAtom for a single protein - NP pair and visualising the results. Its functionality is very limited by design compared to the full command-line program to make it easy to use for beginners without overwhelming them with too many options. 
